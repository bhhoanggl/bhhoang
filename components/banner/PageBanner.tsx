        ...
        >
            {breadcrumbs && (
                <div className="flex items-center space-x-2 mb-6">
                    <Link href="/" className={`text-sm hover:underline ${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>
                        Trang chủ
                    </Link>
            ...
            {cta && (
                <Link
                    href={cta.href}
                    className={`inline-flex items-center px-6 py-3 rounded-lg transition-colors ${theme === 'light'
    ...
    return (
        <div className={`${bgColorClass} py-20 page-banner pl-[285px] shadow-lg`}>
            <div className="container mx-auto px-4">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${imagePosition === 'left' ? 'flex-row-reverse' : ''
                    }`}>
                    {imagePosition === 'left' ? (
                        <>
                            <motion.div
